        ...
        <div>
            <div className="flex my-10 lg:px-side gap-8 flex-col lg:flex-row px-mside">
                ...
                <div className="right lg:w-1/2">
                    ...
                    <p className=" font-medium mt-10">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium quia inventore ad mollitia sed quidem magnam dolore deleniti consequuntur neque molestias fugiat quisquam, voluptates voluptatum, vel autem blanditiis, repellendus esse.
