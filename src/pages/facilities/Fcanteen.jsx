  ...
  return (
    <div>
      ...
      <div className='mt-top '>
        <h1 className='text-3xl font-lato font-bold text-second'>Canteen within School Compound</h1>
        <p className='font-lato text-lg lg:text-2xl  mt-6 lg:w-2/3  ml-6 '>
        Our school cafeteria is a place where students gather for nutritious meals and social interaction. With a focus on healthy choices and a welcoming atmosphere, it's where good food meets great company!
        </p>
      </div>
